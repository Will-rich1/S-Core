                            ...
                            <div class="flex-1 overflow-y-auto p-6">
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <select x-model="formData.category" class="w-full border rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                                ...
                                <div class="flex-1 overflow-y-auto p-6">
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="bg-gray-50 border rounded-lg px-4 py-3 text-sm" x-text="selectedActivity.kategori"></div>
                                        </div>
                ...
                <template x-if="selectedActivity">
                    <div>
                        ...
                        <div class="bg-gray-50 border rounded-lg p-3 mb-6">
                            ...
                            <p class="text-xs text-gray-500 mt-1" x-text="selectedActivity.kategori"></p>
                        </div>
                        <div class="flex gap-3 justify-end">
                        ...
                        <div class="bg-orange-50 border border-orange-200 rounded-lg p-4 mb-4">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-orange-700"><strong>Category:</strong> <span x-text="selectedActivity.kategori"></span></p>
    ...
    <script>
        function dashboardData() {
            return {
                ...
                activities: [
                    { kategori: "Internship/Practical Work", judul: "Internship Certificate", keterangan: "Internship at HR Department...", point: 22, waktu: "12 Aug 2025 20:31:51:823", status: "Approved" },
                    { kategori: "Internship/Practical Work", judul: "Internship Certificate", keterangan: "Internship Certificate at HR...", point: "-", waktu: "12 Aug 2025 20:31:10:010", status: "Rejected" },
                    ...
                    { kategori: "Achievement in Science, Literature and Other Academic Activities (olympiad, pitmapres, etc)", judul: "Pilmapres Region III Finalist", keterangan: "Became Finalist of Pilmapres...", point: 18, waktu: "07 Aug 2025 21:19:52:307", status: "Approved" },
                    { kategori: "Participant in Interest and Talent Activities (sports, arts, and spirituality)", judul: "National Web Development Competition Participant", keterangan: "Became participant in Nation...", point: 10, waktu: "07 Aug 2025 21:18:27:867", status: "Approved" },
                    { kategori: "IPR/Patent", judul: "IPR Terrafrace Application (UI UX Design)", keterangan: "Proof of IPR Terrafrace appli...", point: 20, waktu: "10 Jul 2025 22:28:37:203", status: "Approved" }
                ],
                ...
                saveActivity() {
                    if (!this.formData.category || !this.formData.activityTitle || !this.formData.description || !this.formData.activityDate || !this.formData.fileName) {
                        alert('Please fill all required fields and upload a certificate');
                        return;
                    }
                    
                    if (!this.validateActivityDate(this.formData.activityDate)) {
                        alert(this.dateValidationError);
                        return;
                    }
                    
                    console.log('Saving activity:', this.formData);
                    alert('Activity submitted successfully! It will be reviewed within 3-5 business days.');
                    // Add your save logic here
                    this.closeModal();
                },
                updateActivity() {
                    if (!this.formData.category || !this.formData.activityTitle || !this.formData.description || !this.formData.activityDate) {
                ...
                submitComplaint() {
                    ...
                    alert('Your complaint has been submitted successfully. The admin will review your appeal within 3-5 business days.');
